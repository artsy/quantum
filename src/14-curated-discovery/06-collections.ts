...
/**
 * Return a short description generated by openai using a collection's long description.
 *
 * @param description - an artwork collection's long description
 * @returns a short, one sentence, description
 */
...
/**
 * Return a mapping of artwork collection ids to their model generated respective short descriptions.
 *
 * @param collections - an array of artwork collection objects
...
export async function batchShortDescriptions(
  ...
  const imageData = _.fromPairs(shortDescriptionFieldPairs)
  return imageData
}
